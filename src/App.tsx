...
Oh, I never knew you were the someone waiting for me...`,
    comment:
      "This song reminds me of our first dance together, Deepa. Every word feels like it was written for us...",
  },
  {
    id: 2,
    title: "All of Me",
...
I can't pin you down...`,
  ...
  },
  {
    ...
    comment: "Deepa, every time I hear this song, it feels like it’s narrating the story of us. You’re my favorite melody. ❤️"
    },
    {
    id: 4,
    title: "Judai",
    ...
    comment: "Deepa, the lyrics remind me of how lucky I am to have you in my life. You make every day beautiful. 🌸"
    },
  {
    id: 5,
    ...
    },
  {
    ...
    comment: "This track is good, but nothing compares to the rhythm of your laughter, Deepa."
    },
    {
    id: 8,
    title: "Raani",
    ...
    comment: "Deepa, this song is special, but it’s you who gives meaning to every word in it. 🌹"
    },
    {
    id: 9,
    title: "Jeen Di Gal",
    ...
    comment: "Deepa, if our story had a soundtrack, this would be one of the highlights. 🎶"
    },
    {
    id: 11,
    title: "Laal Ishq",
  ...
  comment: "This song paints a picture of love, but you make it come alive for me."
    ...
    Chahoon rehna sada`,
    comment: "Deepa, every time I hear this, I can’t help but think of us dancing under the stars."
    },
  {
    id: 14,
    ...
    comment: "Deepa, this song feels like a memory of the love we share—timeless and perfect."
    },
    {
    id: 17,
    title: "Benaqab",
...
comment: "If music is what feelings sound like, this song is the sound of you in my heart."
    ...
    comment: "Deepa, you’re my forever song, playing on repeat in my heart."
    },
    {
    id: 22,
...
comment: "A moving song filled with emotional depth."
    ...
    comment: "Deepa, this reminds me of all the little moments we’ve shared that make life so beautiful."
    },
    {
    id: 25,
    title: "Purani Tape",
    ...
    <footer className="bg-white/10 backdrop-blur-lg text-white py-6 mt-12">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-purple-200 text-sm mt-1">
          Dedicated to the love of <span className="text-pink-300 font-semibold">Deepa</span>
        </p>
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4 text-center">
          <div className="space-y-8">
            <h1 className="text-6xl font-bold text-white mb-4">
              ...
              <span className="block text-pink-300 mt-2">Deepa ❤️</span>
            </h1>
